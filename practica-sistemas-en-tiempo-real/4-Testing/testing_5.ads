...
package Testing_5 is
    ...
    Distance_Simulation : tipo_Secuencia_Distancia :=  -- next sample every 100ms.
         ...
         3999,3999,3999,3999,3999, 3999,3999,3999,3999,3999,   -- 3s. Tiempo de colisión de 15 segundos. Alarma 4
         3999,3999,3999,3999,3999, 2550,2550,2550,2550,2550,   -- 4s. Empieza la maniobra de esquive
         2550,2550,2550,2550,2550, 2550,2550,2550,2550,2550,   -- 5s.
         2550,2550,2550,2550,2550, 2550,2550,2550,2550,2550,   -- 6s.
         2550,2550,2550,2550,2550, 3999,3999,3999,3999,3999,   -- 7s. Termina maniobra
         ...
         3999,3999,3999,3999,3999, 3999,3999,3999,3999,3999,   -- 11s. Tiempo de colisión de 15 segundos. Alarma 4
         3999,3999,3999,3999,3999, 2550,2550,2550,2550,2550,   -- 12s. Empieza la maniobra de esquive
         2550,2550,2550,2550,2550, 2550,2550,2550,2550,2550,   -- 13s.
         2550,2550,2550,2550,2550, 2550,2550,2550,2550,2550,   -- 14s.
         2550,2550,2550,2550,2550, 5555,5555,5555,5555,5555,   -- 15s. Termina maniobra
    ...
    Light_Intensity_Simulation: tipo_Secuencia_Light :=  -- 1 muestra cada 100ms.
                 ( 700,700,700,700,700, 700,700,700,700,700,   -- 1s.
                   ...
                   400,400,400,400,400, 400,400,400,400,400,   -- 15s.
    ...
    Joystick_Simulation : tipo_Secuencia_Joystick :=  -- 1 muestra cada 100ms.
      (
         ...
         (+00,+05),(+00,+15),(+00,+25),(+00,+35),(+00,+45),
         (+00,+50),(+00,+55),(+00,+55),(+00,+50),(+00,+45),

         -- 2–3s: mantener giro máximo
         (+00,+55),(+00,+55),(+00,+55),(+00,+50),(+00,+45),
         (+00,+40),(+00,+30),(+00,+20),(+00,+10),(+00,+00),

         -- 3–4s: giro hacia la izquierda (supera -45). Empieza maniobra, Roll := 45
         (+00,-05),(+00,-15),(+00,-25),(+00,-35),(+00,-45),
         (+00,-50),(+00,-55),(+00,-55),(+00,-50),(+00,-45),

         -- 4–5s: mantener giro máximo a la izquierda. Mantiene la maniobra 
         (+00,-55),(+00,-55),(+00,-55),(+00,-50),(+00,-45),
         (+00,-35),(+00,-25),(+00,-15),(+00,-10),(+00,+00),

         -- 5–6s: estabilización nivelada
         (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,+00),
         (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,+00),

         -- 6–7s: giro suave derecha-izquierda alterno. Estabiliza el Roll, ya se puede modificar
         (+00,+10),(+00,+25),(+00,+40),(+00,+25),(+00,+10),
         (+00,+00),(+00,-10),(+00,-25),(+00,-40),(+00,-25),

         -- 7–8s: regreso a nivel
         (+00,-10),(+00,+00),(+00,+10),(+00,+25),(+00,+40),
         (+00,+25),(+00,+10),(+00,+00),(+00,+00),(+00,+00),

         -- 8–9s: giro sostenido a la derecha (supera +45)
         (+00,+20),(+00,+30),(+00,+40),(+00,+50),(+00,+55),
         (+00,+55),(+00,+55),(+00,+50),(+00,+40),(+00,+30),

         -- 9–10s: retorno controlado
         (+00,+20),(+00,+10),(+00,+00),(+00,-10),(+00,-20),
         (+00,-30),(+00,-40),(+00,-50),(+00,-55),(+00,-55),

         -- 10–11s: giro máximo mantenido izquierda (supera -45)
         (+00,-55),(+00,-55),(+00,-55),(+00,-50),(+00,-45),
         (+00,-35),(+00,-25),(+00,-15),(+00,-05),(+00,+00),

         -- 11–12s: oscilación centrada. Iniciamos nuevamente maniobra
         (+00,+05),(+00,+15),(+00,+05),(+00,+00),(+00,-05),
         (+00,-15),(+00,-05),(+00,+00),(+00,+10),(+00,+15),

         -- 12–13s: estabilización
         (+00,+05),(+00,+00),(+00,-05),(+00,+00),(+00,+05),
         (+00,+00),(+00,-05),(+00,+00),(+00,+00),(+00,+00),

         -- 13–14s: prueba brusca derecha-izquierda (supera ±45)
         (+00,+35),(+00,+50),(+00,+55),(+00,+55),(+00,+35),
         (+00,+00),(+00,-35),(+00,-50),(+00,-55),(+00,-55),
         ...
         (+00,+15),(+00,+25),(+00,+35),(+00,+45),(+00,+50),
         (+00,+55),(+00,+55),(+00,+50),(+00,+40),(+00,+30),

         -- 16–17s: regreso al centro (supera -45)
         (+00,+15),(+00,+00),(+00,-15),(+00,-30),(+00,-40),
         (+00,-50),(+00,-55),(+00,-55),(+00,-50),(+00,-35),

         -- 17–18s: recuperación y oscilación leve
         (+00,-20),(+00,-10),(+00,+05),(+00,+20),(+00,+30),
         (+00,+20),(+00,+10),(+00,+00),(+00,-10),(+00,-20),

         -- 18–19s: nivelado
         (+00,-10),(+00,-05),(+00,+00),(+00,+05),(+00,+10),
